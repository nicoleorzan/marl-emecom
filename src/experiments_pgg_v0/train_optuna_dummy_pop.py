...
def setup_training_hyperparams(trial, args):
    ...
    game_params = dict(
        ...
        batch_size = 128,
        lr_actor = 0.0002, #trial.suggest_float("lr_actor", 1e-4, 1e-1, log=True), #0.002 reinforce
        lr_critic = 0.001, #trial.suggest_float("lr_critic", 1e-4, 1e-1, log=True), #0.017 reinforce
        lr_opponent = 0, # trial.suggest_float("lr_opponent", 1e-3, 1e-1, log=True), # 0.007 reinforce
        n_hidden_act = 2,
    ...
    if (args.algorithm == "reinforce"):
        ...
        algo_params = dict(
            ...
            c2 = 0.1, #trial.suggest_float("c2", 0.0001, 0.1, log=True),
