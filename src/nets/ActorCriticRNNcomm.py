...
class ActorCriticRNNcomm(nn.Module):
    ...
    def init_hidden(self):
        self.hState = Variable(torch.zeros(self.num_rnn_layers, self.hidden_dim))
        self.cState = Variable(torch.zeros(self.num_rnn_layers, self.hidden_dim))    

    # observe coins + messages of all other agents
